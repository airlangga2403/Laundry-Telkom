...
import org.d3ifcool.laundrytelkom.databinding.ActivitySetrikaBinding
...
// Show the notification
    ...
    fun setrikaCalculatePrice(baju: Int, celana: Int): Int {
    ...
    private fun inputProductToFirebase(banyakBaju: String, banyakCelana: String) {
        ...
        val helperClass: UserHelperFirebaseProductBajuCelana =
            UserHelperFirebaseProductBajuCelana(
                banyakBaju, banyakCelana, setrikaCalculatePrice(
                    baju,
                    celana
                ).toString()
            )
        reference.child(name).child("Product").child("Product Setrika").child(time)
