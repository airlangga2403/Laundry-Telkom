...
import org.d3ifcool.laundrytelkom.databinding.ActivityExpressBinding
...
class SpreiActivity : AppCompatActivity() {
...
// Show the notification
    ...
    private fun inputProductToFirebase(banyakBaju: String, banyakCelana: String) {
        ...
        reference.child(name).child("Product").child("Product Sprei").child(time)
